  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_key() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, h, t, l) {
            return h + t + l;
      ...
      function parse_keyLiteral() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, k) { return k.join('');})(pos0.offset, pos0.line, pos0.column, result0[1]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
